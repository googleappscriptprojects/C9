...
function loginUser(payload) {
  ...
  var loginSheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("");
...
function getUserDashboardInfo(username) {
  var reportSheet = SpreadsheetApp.getActiveSpreadshee().getSheetByName("");
  var reportData = reportSheet.getRang("A:F").getValues();
